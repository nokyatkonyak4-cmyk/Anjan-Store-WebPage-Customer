...
const isCustomConfigured = !!import.meta.env.VITE_FIREBASE_PROJECT_ID;
...
const databaseId = isCustomConfigured ? (import.meta.env.VITE_FIREBASE_DATABASE_ID || '(default)') : fallbackConfig.firestoreDatabaseId;
