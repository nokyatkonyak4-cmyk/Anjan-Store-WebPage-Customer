...
function AppRouter() {
  ...
  return (
    <>
      ...
      {toastMessage && (
        <div className="fixed top-4 right-4 z-50 bg-white border border-brand-yellow rounded-xl shadow-lg p-4 max-w-sm w-[90%] md:w-full animate-in slide-in-from-top-4 flex flex-col cursor-pointer" onClick={() => { if(toastMessage.url) { window.location.href = toastMessage.url; } setToastMessage(null); }}>
